 ...
 * @author admin
 */
public class AddHaoYouService implements IAjaxService {
	...
	public String execute(AjaxServiceParameter param) throws Exception {
		// 课程编号
		String LoginId = param.getParameter("LoginId");
		...
		String mubiaoyhid=getYongHuBH(LoginId);
		HttpWebs web = new HttpWebs();
		web.init();
		GetUrl getUrl=new GetUrl();
		String url=getUrl.getUrl("AddHY_url");
		Map<String, String> parmMap = new HashMap<String, String>();
		parmMap.put("oid", mubiaoyhid);
