...
<%
	...
	List<List<String>> list = rshelp.getResourceBySearch(null,ziyuanlb,meitilx,currentPage,"10",UID,null,null,"download"); 
				...
				<div class="layout">
					...
					<div class="subnav">
						<ul>
							...
							<li><a
								href="<%=request.getContextPath()%>/servlet/jspdispatchservlet?_qam_dialog=GNDH_ZiYuanXZ" class="subnav-click">资源下载</a>
							</li>
							<li>
...
//提交分页
    function pageSubmit(){
		document.forms[0].action="<%=path%>/jspdispatchservlet?_qam_dialog=GNDH_ZiYuanXZ";
