...
<%
	...
	List<List<String>> list = rshelp.getResourceBySearch(null,ziyuanlb,meitilx,currentPage,"10",UID,"collect",null,null); 
				...
				<div class="layout">
					...
					<div class="subnav">
						<ul>
							...
							<li>
								<a href="<%=request.getContextPath()%>/servlet/jspdispatchservlet?_qam_dialog=GNDH_ZiYuanSC" class="subnav-click">资源收藏</a>
							</li>
							<li>
														...
														<div class="tu_rig">
															...
															<div class="res-button">
																<ul>
																	...
																	<li><a
																		href="javascript:updatecollectcount('<%=res[1]%>')">取消收藏</a>
																	</li>
																</ul>
															</div>
														</div>
...
//提交分页
    function pageSubmit(){
		document.forms[0].action="<%=path%>/jspdispatchservlet?_qam_dialog=GNDH_ZiYuanSC";
