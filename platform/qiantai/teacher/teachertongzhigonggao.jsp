...
List<Object> objSUM=TZGGS.getJSONGongGaoBS(schoolId,key,uid,"2","all","10");
...
List<Object> obj=TZGG.getJSONGongGaoBS(schoolId,key,uid,"2",currentPage,"10");
...
<div class="wrap clearfix">
	<div  class="fl mt-20 w-710">
          <!-- 所在位置 -->
         <div class="td-zt">您所在的位置：<a href="<%=path%>/jspdispatchservlet?_qam_dialog=GNDH_JiaoXueKJ">首页</a>&gt;教师动态 </div>
        <div class="my-jx mt-4">
        <div class="notice-gogao">
        <ul>
        	<c:if test="${msgCode1==1 }">
      		 <%
      		for(int i=0;i<list.size();i++){
      			Map<String,Object> maps=list.get(i);
      		  %>
      		 	<li>
			        <span class="span-fl">【<b><%=maps.get("type")%></b>】<a href ="<%=path%>/jspdispatchservlet?_qam_dialog=GNDH_LSGongGaoXQ&cs_BianHao=<%=maps.get("id")%>"><%=maps.get("title")%></a></span>
...
//提交分页
function pageSubmit(){
	document.forms[0].action="<%=path%>/jspdispatchservlet?_qam_dialog=GNDH_GongGaoLB&_qam_dialog_state=null&_dialog_submit_=GNDH_GongGaoLB";
