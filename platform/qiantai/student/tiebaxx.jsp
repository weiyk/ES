...
<%!
	public String getValue(String json,int page,String imaUrl) throws ParseException{
		...
		for(int j = 0; j < page; j++) {
			...
			html.append("<span class=\"fl cla-1\">"+map.get("xingming")+"["+map.get("schoolName")+"-"+map.get("className")+"]"+"</span> ");
...
<link href="<%=style%>/style/base.css" rel="stylesheet" type="text/css" />
	...
	<style type="">
	.zjx-areatext .the-list li .txt{width:100%;color:#000;margin-left:10px;}
	.zjx-areatext .the-list li .info {padding-right: 10px; width: 90%;}
	</style>
</head>
