...
<%@page import="com.qam.framework.util.LicUtil"%>
...
<form name="form1" method="post" action="<%=request.getContextPath() %>/servlet/desktop.html">
 ...
 <table width="100%" border="0" align="center" cellspacing="0" cellpadding="0" style="height:100%;padding-top: 10px">
  <tr>
    <td>
      <table width="778" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td width="25%"><img src="<%=_qam_img_path %>/rc/logo_login.gif" width="193" height="70px" alt="logo"/></td>
          <td width="37%"><img src="<%=_qam_img_path %>/rc/login_slogan.gif" width="294" height="70px" /></td>
  ...
  <tr>
    <td class="login-bg"><table width="778" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td><img src="<%=_qam_img_path %>/rc/login_mid_name.gif" width="425" height="452" /><br /></td>
        <td>
        	<table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td><img src="<%=_qam_img_path %>/rc/login_mid_01.gif" width="330" height="36" /></td>
          </tr>
          <tr>
            <td class="login-wbg"><table width="94%" border="0" align="center" cellpadding="7" cellspacing="0" class="login01">
              <tr>
                <td align="right">&nbsp;</td>
                <td class="f-s-14"><input name="pz" type="checkbox" id="pz" class="f_checkbox"/>
管理员配置</td>
              </tr>
              <tr>
          ...
          <tr>
            <td><img src="<%=_qam_img_path %>/rc/login_mid_02.gif" width="330" height="36" /></td>
          </tr>
        </table>
        </td>
        <td><img src="<%=_qam_img_path %>/rc/login_mid_03.gif" width="23" height="452" /></td>
      </tr>
    </table></td>
  </tr>
  <tr>
